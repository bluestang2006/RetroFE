...
FIND_PATH(GSTREAMER_gst_INCLUDE_DIR gst/gst.h
                                    PATHS /opt/homebrew/include/gstreamer-1.0 ${GSTREAMER_ROOT}/include ${GSTREAMER_ROOT}/include/gstreamer-1.0 /usr/local/include/gstreamer-1.0 /usr/include/gstreamer-1.0 /usr/local/opt/gstreamer/include/gstreamer-1.0
...
FIND_PATH(GSTREAMER_gstappsink_INCLUDE_DIR gst/app/gstappsink.h
                                    PATHS /opt/homebrew/include/gstreamer-1.0 /usr/local/opt/gst-plugins-base/include /usr/local/opt/gst-plugins-base/include/gstreamer-1.0
...
FIND_PATH(GSTREAMER_gstconfig_INCLUDE_DIR gst/gstconfig.h
                                          PATHS /opt/homebrew/include/gstreamer-1.0 ${GSTREAMER_ROOT}/include ${GSTREAMER_ROOT}/lib/include ${GSTREAMER_ROOT}/include/gstreamer-1.0 /usr/local/include/gstreamer-1.0 /usr/include/gstreamer-1.0 /usr/local/lib/include/gstreamer-1.0 /usr/lib/include/gstreamer-1.0 /usr/local/opt/gstreamer/lib/gstreamer-1.0/include
...
FIND_LIBRARY(GSTREAMER_gstaudio_LIBRARY NAMES gstreamer-audio-1.0 gstaudio-1.0 libgstaudio-1.0 gstaudio
                                        PATHS /opt/homebrew/lib/gstreamer ${GSTREAMER_ROOT}/bin ${GSTREAMER_ROOT}/win32/bin ${GSTREAMER_ROOT}/bin/bin C:/gstreamer/bin ${GSTREAMER_ROOT}/lib ${GSTREAMER_ROOT}/win32/lib /usr/local/lib /usr/lib
                                        ENV LIB
